...
obj/file_layer_test: test/file_layer_test.c lib/file_layer.c lib/disk_layer.c lib/block_layer.c lib/lru_cache.c
	$(CC) -o $@ $^ $(CFLAGS)
...
obj/lru_cache_test: test/lru_cache_test.c lib/lru_cache.c
	$(CC) -o $@ $^ $(CFLAGS)
