...
#define DOUBLE_INDIRECT_BLOCK_COUNT (SINGLE_INDIRECT_BLOCK_COUNT * BLOCK_SIZE / ADDRESS_SIZE)
#define TRIPLE_INDIRECT_BLOCK_COUNT (DOUBLE_INDIRECT_BLOCK_COUNT * BLOCK_SIZE / ADDRESS_SIZE)
